...
%Section 5
    ...
    WordText(ActXWord,TextString,Style,[0,1]);%red text and enter after text
...
%     End With
    actx_word_p.ActiveDocument.TablesOfContents.Add(actx_word_p.Selection.Range,1,...
        upper_heading_p,lower_heading_p,0);
...
function WordText(actx_word_p,text_p,style_p,enters_p,color_p)
    ...
    % actx_word_p.Selection.Font.ColorIndex='wdAuto';%set back to default
    % color - commented out by Raj Vinjamuri since it caused an error
    for k=1:enters_p(2)    
        actx_word_p.Selection.TypeParagraph; %enter
    end
return
